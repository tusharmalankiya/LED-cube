...
uint8_t patterns4[][3] = {
	{0b11111111, 0b01111111, 0b00111111}, // Layer 0: All LEDs off
	{0b00110111, 0b00100111, 0b00000111}, // Layer 1: All LEDs off
	{0b00000011, 0b00000001, 0b00000000}, // Layer 2: All LEDs off
};

uint8_t patterns4_blink[][3] = {
	{0b11111111, 0b01111111, 0b10111111}, // Layer 0: All LEDs off
	{0b11110111, 0b11101111, 0b11011111}, // Layer 1: All LEDs off
